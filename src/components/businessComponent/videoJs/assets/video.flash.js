...
var Flash = (function(_Tech) {
  ...
  Flash.prototype.createEl = function createEl() {
    ...
    if (!options.swf) {
      options.swf = "https://vjs.zencdn.net/swf/5.4.1/video-js.swf";
    }
  ...
  Flash.prototype.setSrc = function setSrc(src) {
    ...
    this.el_.vjs_src && this.el_.vjs_src(src);
  ...
  Flash.prototype.setCurrentTime = function setCurrentTime(time) {
    ...
    if (seekable.length) {
      ...
      this.el_.vjs_setProperty && this.el_.vjs_setProperty("currentTime", time);
  ...
  Flash.prototype.currentTime = function currentTime() {
    ...
    return this.el_.vjs_getProperty && this.el_.vjs_getProperty("currentTime");
  };
  ...
  Flash.prototype.currentSrc = function currentSrc() {
    ...
    return this.el_.vjs_getProperty && this.el_.vjs_getProperty("currentSrc");
  };
  ...
  Flash.prototype.duration = function duration() {
    ...
    var duration =
      this.el_.vjs_getProperty && this.el_.vjs_getProperty("duration");
  ...
  Flash.prototype.poster = function poster() {
    this.el_.vjs_getProperty && this.el_.vjs_getProperty("poster");
  };
  ...
  Flash.prototype.buffered = function buffered() {
    var ranges = this.el_.vjs_getProperty
      ? this.el_.vjs_getProperty("buffered")
      : [];
  ...
  Flash.prototype.getVideoPlaybackQuality = function getVideoPlaybackQuality() {
    var videoPlaybackQuality =
      ...
      this.el_.vjs_getProperty("getVideoPlaybackQuality");
...
function _createSetter(attr) {
  ...
  _api["set" + attrUpper] = function(val) {
    return this.el_.vjs_setProperty && this.el_.vjs_setProperty(attr, val);
  };
}
...
function _createGetter(attr) {
  _api[attr] = function() {
    return this.el_.vjs_getProperty && this.el_.vjs_getProperty(attr);
  };
}
...
Flash.isSupported = function() {
  ...
  if (
    (videojs.browser.IS_CHROME && !videojs.browser.IS_ANDROID) ||
...
Flash.version = function() {
  ...
  // IE
  try {
    version$$1 = new window.ActiveXObject("ShockwaveFlash.ShockwaveFlash")
      .GetVariable("$version")
      .replace(/\D+/g, ",")
      .match(/^,?(.+),?$/)[1];
