 ...
 */
  ...
  var TOUCH_ENABLED =
    isReal() &&
    ("ontouchstart" in window_1 ||
      (window_1.DocumentTouch &&
        window_1.document instanceof window_1.DocumentTouch));

  var BACKGROUND_SIZE_SUPPORTED =
    isReal() &&
    "backgroundSize" in window_1.document.createElement("video").style;
 ...
 */
  ...
  var normalizeListenArgs = function normalizeListenArgs(self, args) {
    ...
    var isTargetingSelf =
      args.length < 3 || args[0] === self || args[0] === self.eventBusEl_;
    var target = void 0;
    var type = void 0;
    var listener = void 0;
    ...
    one: function one$$1() {
      ...
      if (isTargetingSelf) {
        ...
        var wrapper = function wrapper() {
          for (
            var _len3 = arguments.length, largs = Array(_len3), _key3 = 0;
            _key3 < _len3;
            _key3++
          ) {
  ...
  var Component = (function() {
    ...
    Component.prototype.createEl = function createEl$$1(
      tagName,
      properties,
      attributes
    ) {
    ...
    Component.prototype.addChild = function addChild(child) {
      ...
      componentName =
        componentName || (component.name && toTitleCase(component.name()));
        ...
        workingChildren
          ...
          .filter(function(child) {
            ...
            var c = Component.getComponent(
              child.opts.componentClass || toTitleCase(child.name)
            );
    ...
    Component.prototype.toggleClass = function toggleClass$$1(
      classToToggle,
      predicate
    ) {
    ...
    Component.prototype.setAttribute = function setAttribute$$1(
      attribute,
      value
    ) {
    ...
    Component.prototype.removeAttribute = function removeAttribute$$1(
      attribute
    ) {
   ...
   */
    ...
    Component.prototype.requestAnimationFrame = function requestAnimationFrame(
      fn
    ) {
      var _this4 = this;
  ...
  Component.prototype.supportsRaf_ =
    typeof window_1.requestAnimationFrame === "function" &&
    typeof window_1.cancelAnimationFrame === "function";
  ...
  var ModalDialog = (function(_Component) {
    ...
    ModalDialog.prototype.focusableEls_ = function focusableEls_() {
      ...
      return Array.prototype.filter.call(allChildren, function(child) {
        return (
          ((child instanceof window_1.HTMLAnchorElement ||
            child instanceof window_1.HTMLAreaElement) &&
  ...
  var AudioTrackList = (function(_TrackList) {
    ...
    function AudioTrackList() {
      ...
      list = ((_this = possibleConstructorReturn(
        this,
  ...
  var parseCues = function parseCues(srcContent, track) {
    var parser = new window_1.WebVTT.Parser(
      window_1,
      window_1.vttjs,
      window_1.WebVTT.StringDecoder()
    );
    var errors = [];
    ...
    if (errors.length > 0) {
      if (window_1.console && window_1.console.groupCollapsed) {
        window_1.console.groupCollapsed(
        ...
        if (typeof window_1.WebVTT !== "function") {
          if (track.tech_) {
            ...
            track.tech_.on("vttjserror", function() {
              log$1.error(
                "vttjs failed to load, stopping trying to process " + track.src
              );
  ...
  var TextTrack = (function(_Track) {
    ...
    function TextTrack() {
      ...
      var tt = ((_this = possibleConstructorReturn(
        this,
  ...
  var AudioTrack = (function(_Track) {
    ...
    function AudioTrack() {
      ...
      // on IE8 this will be a document element
      // for every other browser this will be a normal object
      var track = ((_this = possibleConstructorReturn(
        this,
        _Track.call(this, settings)
      )),
      _this);
 ...
 */
  ...
  WebVTT$1.processCues = function(window, cues, overlay) {
    ...
    var boxPositions = [],
      ...
      fontSize =
        Math.round(containerBox.height * FONT_SIZE_PERCENT * 100) / 100;
    var styleOptions = {
        ...
        while (self.buffer) {
          ...
          switch (self.state) {
            ...
            case "ID":
              ...
              self.cue = new (self.vttjs.VTTCue || self.window.VTTCue)(
                0,
                0,
                ""
              );
  ...
  ================================================================================ */
    ...
    Tech.prototype.addWebVttScript_ = function addWebVttScript_() {
      ...
      if (document_1.body.contains(this.el())) {
        ...
        if (
          ...
          isPlain(browserIndex) &&
          Object.keys(browserIndex).length > 0
        ) {
    ...
    Tech.prototype.createRemoteTextTrack = function createRemoteTextTrack(
      options
    ) {
  ...
  var MediaLoader = (function(_Component) {
    ...
    function MediaLoader(player, options, ready) {
      ...
      var _this = possibleConstructorReturn(
        this,
        _Component.call(this, player, options_, ready)
      );
  ...
  var ClickableComponent = (function(_Component) {
    ...
    ClickableComponent.prototype.createControlTextEl = function createControlTextEl(
      el
    ) {
    ...
    ClickableComponent.prototype.handleKeyPress = function handleKeyPress(
      event
    ) {
  ...
  var TimeDisplay = (function(_Component) {
    ...
    function TimeDisplay(player, options) {
      ...
      _this.throttledUpdateContent = throttle(
        bind(_this, _this.updateContent),
        25
      );
    ...
    TimeDisplay.prototype.updateFormattedTime_ = function updateFormattedTime_(
      time
    ) {
  ...
  var CurrentTimeDisplay = (function(_TimeDisplay) {
    ...
    function CurrentTimeDisplay(player, options) {
      ...
      var _this = possibleConstructorReturn(
        this,
        _TimeDisplay.call(this, player, options)
      );
  ...
  var TimeTooltip = (function(_Component) {
    ...
    TimeTooltip.prototype.update = function update(
      seekBarRect,
      seekBarPoint,
      content
    ) {
  ...
  var PlayProgressBar = (function(_Component) {
    ...
    PlayProgressBar.prototype.update = function update(
      seekBarRect,
      seekBarPoint
    ) {
      var _this2 = this;
  ...
  var ProgressControl = (function(_Component) {
    ...
    function ProgressControl(player, options) {
      ...
      _this.throttledHandleMouseSeek = throttle(
        bind(_this, _this.handleMouseSeek),
        25
      );
    ...
    ProgressControl.prototype.handleMouseMove = function handleMouseMove(
      event
    ) {
    ...
    ProgressControl.prototype.handleMouseSeek = function handleMouseSeek(
      event
    ) {
      var seekBar = this.getChild("seekBar");
    ...
    ProgressControl.prototype.handleMouseDown = function handleMouseDown(
      event
    ) {
  ...
  var FullscreenToggle = (function(_Button) {
    ...
    FullscreenToggle.prototype.buildCSSClass = function buildCSSClass() {
      return (
        "vjs-fullscreen-control " + _Button.prototype.buildCSSClass.call(this)
      );
    };
  ...
  var MenuButton = (function(_Component) {
    ...
    MenuButton.prototype.handleSubmenuKeyPress = function handleSubmenuKeyPress(
      event
    ) {
      // Escape (27) key or Tab (9) key unpress the 'button'
      if (event.which === 27 || event.which === 9) {
  ...
  var TextTrackMenuItem = (function(_MenuItem) {
    ...
    TextTrackMenuItem.prototype.handleSelectedLanguageChange = function handleSelectedLanguageChange(
      event
    ) {
  ...
  var OffTextTrackMenuItem = (function(_TextTrackMenuItem) {
    ...
    OffTextTrackMenuItem.prototype.handleSelectedLanguageChange = function handleSelectedLanguageChange(
      event
    ) {
      var tracks = this.player().textTracks();
      var allHidden = true;
      ...
      for (var i = 0, l = tracks.length; i < l; i++) {
        ...
        if (
          ["captions", "descriptions", "subtitles"].indexOf(track.kind) > -1 &&
          track.mode === "showing"
        ) {
          allHidden = false;
          break;
  ...
  var ChaptersButton = (function(_TextTrackButton) {
    ...
    ChaptersButton.prototype.buildWrapperCSSClass = function buildWrapperCSSClass() {
      return (
        "vjs-chapters-button " +
        _TextTrackButton.prototype.buildWrapperCSSClass.call(this)
      );
    };
    ...
    ChaptersButton.prototype.update = function update(event) {
      if (
        !this.track_ ||
        (event && (event.type === "addtrack" || event.type === "removetrack"))
      ) {
  ...
  var DescriptionsButton = (function(_TextTrackButton) {
    ...
    DescriptionsButton.prototype.handleTracksChange = function handleTracksChange(
      event
    ) {
      var tracks = this.player().textTracks();
      var disabled = false;
  ...
  var CaptionsButton = (function(_TextTrackButton) {
    ...
    CaptionsButton.prototype.createItems = function createItems() {
      ...
      if (
        ...
        items.push(
          new CaptionSettingsMenuItem(this.player_, { kind: this.kind_ })
        );
  ...
  var SubsCapsMenuItem = (function(_TextTrackMenuItem) {
    ...
    function SubsCapsMenuItem() {
      ...
      return possibleConstructorReturn(
        this,
        _TextTrackMenuItem.apply(this, arguments)
      );
    }

    SubsCapsMenuItem.prototype.createEl = function createEl(
      type,
      props,
      attrs
    ) {
  ...
  var SubsCapsButton = (function(_TextTrackButton) {
    ...
    function SubsCapsButton(player) {
      ...
      var _this = possibleConstructorReturn(
        this,
        _TextTrackButton.call(this, player, options)
      );

      _this.label_ = "subtitles";
      if (
        ["en", "en-us", "en-ca", "fr-ca"].indexOf(_this.player_.language_) > -1
      ) {
    ...
    SubsCapsButton.prototype.createItems = function createItems() {
      ...
      if (
        ...
        items.push(
          new CaptionSettingsMenuItem(this.player_, { kind: this.label_ })
        );
  ...
  var AudioTrackMenuItem = (function(_MenuItem) {
    ...
    AudioTrackMenuItem.prototype.handleTracksChange = function handleTracksChange(
      event
    ) {
  ...
  var AudioTrackButton = (function(_TrackButton) {
    ...
    AudioTrackButton.prototype.buildCSSClass = function buildCSSClass() {
      return (
        "vjs-audio-button " + _TrackButton.prototype.buildCSSClass.call(this)
      );
    };
  ...
  var PlaybackRateMenuButton = (function(_MenuButton) {
    ...
    PlaybackRateMenuButton.prototype.buildCSSClass = function buildCSSClass() {
      return (
        "vjs-playback-rate " + _MenuButton.prototype.buildCSSClass.call(this)
      );
    };
  ...
  var ErrorDisplay = (function(_ModalDialog) {
    ...
    ErrorDisplay.prototype.buildCSSClass = function buildCSSClass() {
      return (
        "vjs-error-display " + _ModalDialog.prototype.buildCSSClass.call(this)
      );
    };
  ...
  ErrorDisplay.prototype.options_ = mergeOptions(
    ModalDialog.prototype.options_,
    {
      pauseOnOpen: false,
      fillAlways: true,
  ...
  var TextTrackSettings = (function(_ModalDialog) {
    ...
    TextTrackSettings.prototype.createElSelect_ = function createElSelect_(
      key
    ) {
      var _this2 = this;
    ...
    TextTrackSettings.prototype.createElControls_ = function createElControls_() {
      ...
      return createEl("div", {
        ...
        innerHTML: [
          '<button class="vjs-default-button" title="' +
            defaultsDescription +
            '">',
          this.localize("Reset"),
  ...
  var Html5 = (function(_Tech) {
    ...
    Html5.prototype.supportsFullScreen = function supportsFullScreen() {
      if (typeof this.el_.webkitEnterFullScreen === "function") {
        var userAgent =
          (window_1.navigator && window_1.navigator.userAgent) || "";
    ...
    Html5.prototype.createRemoteTextTrack = function createRemoteTextTrack(
      options
    ) {
      if (!this.featuresNativeTextTracks) {
  ...
  var Player = (function(_Component) {
    ...
    Player.prototype.createEl = function createEl$$1() {
      ...
      if (window_1.VIDEOJS_NO_DYNAMIC_STYLE !== true) {
        ...
        head.insertBefore(
          this.styleEl_,
          defaultsStyleEl ? defaultsStyleEl.nextSibling : head.firstChild
        );
      }
    ...
    Player.prototype.dimension = function dimension(
      _dimension,
      value,
      skipListeners
    ) {
      ...
      if (isNaN(parsedVal)) {
        log$1.error(
          'Improper value "' + value + '" supplied for for ' + _dimension
        );
        return;
      }
    ...
    Player.prototype.loadTech_ = function loadTech_(techName, source) {
      ...
      TECH_EVENTS_RETRIGGER.forEach(function(event) {
        _this2.on(
          _this2.tech_,
          event,
          _this2["handleTech" + toTitleCase(event) + "_"]
        );
      });
    ...
    Player.prototype.selectSource = function selectSource(sources) {
      ...
      var finder = function finder(_ref2, source) {
        ...
        if (
          tech.canPlaySource(source, _this6.options_[techName.toLowerCase()])
        ) {
 ...
 */
  ...
  var createBasicPlugin = function createBasicPlugin(name, plugin) {
    var basicPluginWrapper = function basicPluginWrapper() {
      ...
      triggerSetupEvent(
        this,
        { name: name, plugin: plugin, instance: null },
        true
      );
  ...
  var createPluginFactory = function createPluginFactory(name, PluginSubClass) {
    ...
    return function() {
      triggerSetupEvent(
        this,
        { name: name, plugin: PluginSubClass, instance: null },
        true
      );
  ...
  var Plugin = (function() {
    ...
    Plugin.isBasic = function isBasic(plugin) {
      ...
      return (
        typeof p === "function" && !Plugin.prototype.isPrototypeOf(p.prototype)
      );
    };
  ...
  var extendFn = function extendFn(superClass) {
    ...
    if (
      (typeof subClassMethods === "undefined"
        ? "undefined"
        : _typeof(subClassMethods)) === "object"
    ) {
  ...
  [
    ...
    videojs[k] = function() {
      log$1.warn(
        "videojs." + k + "() is deprecated; use videojs.dom." + k + "() instead"
      );
